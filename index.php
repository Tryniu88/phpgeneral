...
<body>
    ...
    <?php
        ...
        {         
            ...
            $sql = "INSERT INTO `phpgeneraltab`(`ID`, `imie`, `nazwisko`, `wiek`) VALUES (null,'" . $_POST["name"] . "','" . $_POST["lastname"] . "','" . $_POST["wiek"] . "')";
        ...
        if (!empty($_POST["id"]))
        {
            ...
            $sql = "DELETE FROM `phpgeneraltab` WHERE ID=" . $_POST["id"];
